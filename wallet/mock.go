...
func (m *mockChainClient) Rescan(*chainhash.Hash, []diviutil.Address,
	map[wire.OutPoint]diviutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]diviutil.Address) error {
	return nil
}
