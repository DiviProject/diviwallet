...
Package walletdb provides a namespaced database interface for diviwallet.
...
[![GoDoc](https://godoc.org/github.com/DiviProject/diviwallet/walletdb?status.png)]
(http://godoc.org/github.com/DiviProject/diviwallet/walletdb)
...
http://localhost:6060/pkg/github.com/DiviProject/diviwallet/walletdb

## Installation

```bash
$ go get github.com/DiviProject/diviwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/DiviProject/diviwallet/walletdb#example-package--BasicUsage)
